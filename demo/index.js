...
// AppRegistry.registerComponent('myNativeApp', () => HelloWorld);
// AppRegistry.registerComponent('myNativeApp', ()=>FlexTest);
// AppRegistry.registerComponent('myNativeApp', () => FlexDiceTest);
// AppRegistry.registerComponent('myNativeApp', () => FetchNetData);
// AppRegistry.registerComponent('myNativeApp', () => BannerTest);
   AppRegistry.registerComponent('myNativeApp', ()=>TopTabViewTest);
// AppRegistry.registerComponent('myNativeApp', ()=>BottomTabViewTest);
// AppRegistry.registerComponent('myNativeApp', ()=>TaberTest);
// AppRegistry.registerComponent('myNativeApp', ()=>AnatomyTest);
// AppRegistry.registerComponent('myNativeApp', ()=>ScrollViewTest);
// AppRegistry.registerComponent('myNativeApp', ()=>ListViewTest);
//AppRegistry.registerComponent('myNativeApp', ()=>StartUp);
// AppRegistry.registerComponent('myNativeApp', ()=>ParallaxTest);